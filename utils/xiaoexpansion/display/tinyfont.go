package xiaodisplay // import "tinygo.org/x/tinyfont"

// rewritten from github.com/tinygo-org/tinyfont to work with ssd1306
...
func drawGlyphRotated(display ssd1306.Device, x int16, y int16, glyph tinyfont.Glyph, color color.RGBA, rotation Rotation) {
	bitmapOffset := 0
	bitmap := byte(0)
